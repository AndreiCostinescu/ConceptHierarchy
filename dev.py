    ...
    try:
        ...
        if exc.code in (404, 422):
            ...
            fail(
                ...
                "https://github.com/{}/commits/main.".format(DEVTOOLS_REV, DEVTOOLS_REPO, DEVTOOLS_REPO)
            )
        if exc.code == 403:
            fail(
...
sys.exit(subprocess.call([sys.executable, os.path.join(DEVTOOLS_DIR, "scripts", "devtools.py")] + sys.argv[1:]))
